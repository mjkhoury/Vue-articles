...
<template>
  <div id="add-blog">
    <h1 class="slideRight resTitle centered" style="color:black">Post an Article </h1>
    <div v-if="submitted">
    ...
    <form v-if="!submitted">
      ...
      <textarea class="textIn" v-model="blog.content" required placeholder="Real-time Preview in the preview field"></textarea>
      <div id="checkboxes">
        <label>Ninjas</label>
